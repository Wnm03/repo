...
Terakhir digenerate: 2026-08-01T22:05:14.158Z
Total file test (`tests/*.test.js`): 175 · Total module family: 15
...
| `modules/cross` | 17 | 4 |  |
| `modules/home` | 3 | 4 |  |
| `modules/business` | 10 | 8 |  |
| `modules/ai` | 7 | 10 |  |
| `modules/asset` | 14 | 18 |  |
| `modules/shop` | 14 | 31 |  |
| `modules/finance` | 41 | 43 |  |
| `root` | 19 | 43 |  |
| `modules/vehicle` | 75 | 54 |  |
| `modules/shared` | 29 | 56 |  |
